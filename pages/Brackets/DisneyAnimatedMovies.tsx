    ...
    return (
        <Grid container wrap="nowrap" className={classes.bracket}>
            <div className="bracket-left">
                <div className="round">
                    <Match direction="left" team1={Bracket.Princesses[0].title} team2={Bracket.Princesses[15].title} click={handleWinner} id={1}></Match>
                    <Match direction="left" team1={Bracket.Princesses[1].title} team2={Bracket.Princesses[14].title} click={handleWinner} id={2}></Match>
                    <Match direction="left" team1={Bracket.Princesses[2].title} team2={Bracket.Princesses[13].title} click={handleWinner} id={3}></Match>
                    <Match direction="left" team1={Bracket.Princesses[3].title} team2={Bracket.Princesses[12].title} click={handleWinner} id={4}></Match>
                    <Match direction="left" team1={Bracket.Princesses[4].title} team2={Bracket.Princesses[11].title} click={handleWinner} id={5}></Match>
                    <Match direction="left" team1={Bracket.Princesses[5].title} team2={Bracket.Princesses[10].title} click={handleWinner} id={6}></Match>
                    <Match direction="left" team1={Bracket.Princesses[6].title} team2={Bracket.Princesses[9].title} click={handleWinner} id={7}></Match>
                    <Match direction="left" team1={Bracket.Princesses[7].title} team2={Bracket.Princesses[8].title} click={handleWinner} id={8}></Match>
                    <Match direction="left" team1={Bracket.EarlyYears[0].title} team2={Bracket.EarlyYears[15].title} click={handleWinner} id={9}></Match>
                    <Match direction="left" team1={Bracket.EarlyYears[1].title} team2={Bracket.EarlyYears[14].title} click={handleWinner} id={10}></Match>
                    <Match direction="left" team1={Bracket.EarlyYears[2].title} team2={Bracket.EarlyYears[13].title} click={handleWinner} id={11}></Match>
                    <Match direction="left" team1={Bracket.EarlyYears[3].title} team2={Bracket.EarlyYears[12].title} click={handleWinner} id={12}></Match>
                    <Match direction="left" team1={Bracket.EarlyYears[4].title} team2={Bracket.EarlyYears[11].title} click={handleWinner} id={13}></Match>
                    <Match direction="left" team1={Bracket.EarlyYears[5].title} team2={Bracket.EarlyYears[10].title} click={handleWinner} id={14}></Match>
                ...
                <div className="round">
                    <Match direction="left" team1={winner1} team2={winner2} click={handleWinner} id={65}></Match>
                    <Match direction="left" team1={winner3} team2={winner4} click={handleWinner} id={66}></Match>
                    <Match direction="left" team1={winner5} team2={winner6} click={handleWinner} id={67}></Match>
                    <Match direction="left" team1={winner7} team2={winner8} click={handleWinner} id={68}></Match>
                    <Match direction="left" team1={winner9} team2={winner10} click={handleWinner} id={69}></Match>
                    <Match direction="left" team1={winner11} team2={winner12} click={handleWinner} id={70}></Match>
                    <Match direction="left" team1={winner13} team2={winner14} click={handleWinner} id={71}></Match>
                    <Match direction="left" team1={winner15} team2={winner16} click={handleWinner} id={72}></Match>
                    <Match direction="left" team1={winner17} team2={winner18} click={handleWinner} id={73}></Match>
                    <Match direction="left" team1={winner19} team2={winner20} click={handleWinner} id={74}></Match>
                    <Match direction="left" team1={winner21} team2={winner22} click={handleWinner} id={75}></Match>
                    <Match direction="left" team1={winner23} team2={winner24} click={handleWinner} id={76}></Match>
                    <Match direction="left" team1={winner25} team2={winner26} click={handleWinner} id={77}></Match>
                    <Match direction="left" team1={winner27} team2={winner28} click={handleWinner} id={78}></Match>
                    <Match direction="left" team1={winner29} team2={winner30} click={handleWinner} id={79}></Match>
                    <Match direction="left" team1={winner31} team2={winner32} click={handleWinner} id={80}></Match>
                </div>

               <div className="round">
                    <Match direction="left" team1={winner65} team2={winner66} click={handleWinner} id={80}></Match>
                    <Match direction="left" team1={winner67} team2={winner68} click={handleWinner} id={80}></Match>
                    <Match direction="left" team1={winner69} team2={winner70} click={handleWinner} id={80}></Match>
                    <Match direction="left" team1={winner71} team2={winner72} click={handleWinner} id={80}></Match>
                    <Match direction="left" team1={winner73} team2={winner74} click={handleWinner} id={80}></Match>
                    <Match direction="left" team1={winner75} team2={winner76} click={handleWinner} id={80}></Match>
                    <Match direction="left" team1={winner77} team2={winner78} click={handleWinner} id={80}></Match>
                    <Match direction="left" team1={winner79} team2={winner80} click={handleWinner} id={80}></Match>
                </div>
 {/*
                <div className="round">
            ...
            */}
                ...
                <div className="round">
                    <Match direction="right" team1={winner33} team2={winner34} click={handleWinner} id={81}></Match>
                    <Match direction="right" team1={winner35} team2={winner36} click={handleWinner} id={82}></Match>
                    <Match direction="right" team1={winner37} team2={winner38} click={handleWinner} id={83}></Match>
                    <Match direction="right" team1={winner39} team2={winner40} click={handleWinner} id={84}></Match>
                    <Match direction="right" team1={winner41} team2={winner42} click={handleWinner} id={85}></Match>
                    <Match direction="right" team1={winner43} team2={winner44} click={handleWinner} id={86}></Match>
                    <Match direction="right" team1={winner45} team2={winner46} click={handleWinner} id={87}></Match>
                    <Match direction="right" team1={winner47} team2={winner48} click={handleWinner} id={88}></Match>
                    <Match direction="right" team1={winner49} team2={winner50} click={handleWinner} id={89}></Match>
                    <Match direction="right" team1={winner51} team2={winner52} click={handleWinner} id={90}></Match>
                    <Match direction="right" team1={winner53} team2={winner54} click={handleWinner} id={91}></Match>
                    <Match direction="right" team1={winner55} team2={winner56} click={handleWinner} id={92}></Match>
                    <Match direction="right" team1={winner57} team2={winner58} click={handleWinner} id={93}></Match>
                    <Match direction="right" team1={winner59} team2={winner60} click={handleWinner} id={94}></Match>
                    <Match direction="right" team1={winner61} team2={winner62} click={handleWinner} id={95}></Match>
                    <Match direction="right" team1={winner63} team2={winner64} click={handleWinner} id={96}></Match>
                </div> 

                <div className="round">
                    <Match direction="right" team1={Bracket.ComingofAge[0].title} team2={Bracket.ComingofAge[15].title} click={handleWinner} id={33}></Match>
                    <Match direction="right" team1={Bracket.ComingofAge[1].title} team2={Bracket.ComingofAge[14].title} click={handleWinner} id={34}></Match>
                    <Match direction="right" team1={Bracket.ComingofAge[2].title} team2={Bracket.ComingofAge[13].title} click={handleWinner} id={35}></Match>
                    <Match direction="right" team1={Bracket.ComingofAge[3].title} team2={Bracket.ComingofAge[12].title} click={handleWinner} id={36}></Match>
                    <Match direction="right" team1={Bracket.ComingofAge[4].title} team2={Bracket.ComingofAge[11].title} click={handleWinner} id={37}></Match>
                    <Match direction="right" team1={Bracket.ComingofAge[5].title} team2={Bracket.ComingofAge[10].title} click={handleWinner} id={38}></Match>
                    <Match direction="right" team1={Bracket.ComingofAge[6].title} team2={Bracket.ComingofAge[9].title} click={handleWinner} id={39}></Match>
                    <Match direction="right" team1={Bracket.ComingofAge[7].title} team2={Bracket.ComingofAge[8].title} click={handleWinner} id={40}></Match>
                    <Match direction="right" team1={Bracket.Sequals1[0].title} team2={Bracket.Sequals1[15].title} click={handleWinner} id={41}></Match>
                    <Match direction="right" team1={Bracket.Sequals1[1].title} team2={Bracket.Sequals1[14].title} click={handleWinner} id={42}></Match>
                    <Match direction="right" team1={Bracket.Sequals1[2].title} team2={Bracket.Sequals1[13].title} click={handleWinner} id={43}></Match>
                    <Match direction="right" team1={Bracket.Sequals1[3].title} team2={Bracket.Sequals1[12].title} click={handleWinner} id={44}></Match>
                    <Match direction="right" team1={Bracket.Sequals1[4].title} team2={Bracket.Sequals1[11].title} click={handleWinner} id={45}></Match>
                    <Match direction="right" team1={Bracket.Sequals1[5].title} team2={Bracket.Sequals1[10].title} click={handleWinner} id={46}></Match>
                    <Match direction="right" team1={Bracket.Sequals1[6].title} team2={Bracket.Sequals1[9].title} click={handleWinner} id={47}></Match>
                    <Match direction="right" team1={Bracket.Sequals1[7].title} team2={Bracket.Sequals1[8].title} click={handleWinner} id={48}></Match>
                    <Match direction="right" team1={Bracket.Pixarish[0].title} team2={Bracket.Pixarish[15].title} click={handleWinner} id={49}></Match>
                    <Match direction="right" team1={Bracket.Pixarish[1].title} team2={Bracket.Pixarish[14].title} click={handleWinner} id={50}></Match>
                    <Match direction="right" team1={Bracket.Pixarish[2].title} team2={Bracket.Pixarish[13].title} click={handleWinner} id={51}></Match>
                    <Match direction="right" team1={Bracket.Pixarish[3].title} team2={Bracket.Pixarish[12].title} click={handleWinner} id={52}></Match>
                    <Match direction="right" team1={Bracket.Pixarish[4].title} team2={Bracket.Pixarish[11].title} click={handleWinner} id={53}></Match>
                    <Match direction="right" team1={Bracket.Pixarish[5].title} team2={Bracket.Pixarish[10].title} click={handleWinner} id={54}></Match>
                    <Match direction="right" team1={Bracket.Pixarish[6].title} team2={Bracket.Pixarish[9].title} click={handleWinner} id={55}></Match>
                    <Match direction="right" team1={Bracket.Pixarish[7].title} team2={Bracket.Pixarish[8].title} click={handleWinner} id={56}></Match>
                    <Match direction="right" team1={Bracket.TFCentury[0].title} team2={Bracket.TFCentury[15].title} click={handleWinner} id={57}></Match>
                    <Match direction="right" team1={Bracket.TFCentury[1].title} team2={Bracket.TFCentury[14].title} click={handleWinner} id={58}></Match>
                    <Match direction="right" team1={Bracket.TFCentury[2].title} team2={Bracket.TFCentury[13].title} click={handleWinner} id={59}></Match>
                    <Match direction="right" team1={Bracket.TFCentury[3].title} team2={Bracket.TFCentury[12].title} click={handleWinner} id={60}></Match>
                    <Match direction="right" team1={Bracket.TFCentury[4].title} team2={Bracket.TFCentury[11].title} click={handleWinner} id={61}></Match>
                    <Match direction="right" team1={Bracket.TFCentury[5].title} team2={Bracket.TFCentury[10].title} click={handleWinner} id={62}></Match>
                    <Match direction="right" team1={Bracket.TFCentury[6].title} team2={Bracket.TFCentury[9].title} click={handleWinner} id={63}></Match>
                    <Match direction="right" team1={Bracket.TFCentury[7].title} team2={Bracket.TFCentury[8].title} click={handleWinner} id={64}></Match>
                </div>
            </div>
        </Grid>
    );
